...
! function(t) {
    ...
    i.resize = E(u, _), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function(t) {
        ...
        h = !0, p ? (p = !1, f.each(r, m)) : f.each(o, L), f.each(a, L), i.resize.up()
    }, i.load = function(t) {
        k.then(t)
    }, i.destroy = function(t) {
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, v), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === k.state() && S()
    }, s(i.ready), S(), t.exports = window.Webflow = i
}, function(t, e, n) {
    "use strict";
    var i = n(2)(n(6));
    window.tram = function(t) {
        ...
        if (T.transition) {
            var j = T.timing.dom;
            if (A.style[j] = f["ease-in-back"][0], !A.style[j])
                for (var q in d) f[q][0] = d[q]
        }
        var $ = e.frame = function() {
                var t = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame;
                return t && T.bind ? t.bind(p) : function(t) {
                    p.setTimeout(t, 16)
                }
            }(),
            F = e.now = function() {
            ...
            C = l(function(e) {
                ...
                e.init = function(e) {
                    ...
                    T.backface && H.hideBackface && X(this.el, T.backface.css, "hidden")
            ...
            U = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for ($(n), e = F(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = F()), this.active = !0, t = this, 1 === u.push(t) && $(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        e.fallback = function(t) {
            if (!T.transition) return H.fallback = !0;
            H.agentTests.push("(" + t + ")");
        ...
        T.transform && (Y.transform = [R], Z = {
            ...
            skewX: [k],
            skewY: [k]
        }), T.transform && T.backface && (Z.z = [x, "translateZ"], Z.rotateZ = [k], Z.scaleZ = [b], Z.perspective = [y]);
        var J = /ms/,
            Q = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
            ...
            r.done = a.find("> .w-form-done"), r.fail = a.find("> .w-form-fail"), r.fileUploads = a.find(".w-file-upload"), r.fileUploads.each(function(e) {
                ! function(e, n) {
                    ...
                    if (w) l.on("click", function(t) {
                        ...
                        m.on("click", function() {
                            l.removeAttr("data-value"), l.val(""), v.html(""), o.toggle(!0), s.toggle(!1)
                        }), l.on("change", function(r) {
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), v.text(i.name), A() || k(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var i = {
                                    name: e.name,
                                    size: e.size
                                };
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = g : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = b), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, A() || x(n)
                    }
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), b.test(s) ? r.handler = L : s || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : E : g())
        }
        ...
        function _(e, n) {
            ...
            return n = n || {}, e.find(':input:not([type="submit"]):not([type="file"])').each(function(r, o) {
                ...
                "string" == typeof c && (c = t.trim(c)), n[u] = c, i = i || function(t, e, n, i) {
                    var r = null;
                    "password" === e ? r = "Passwords cannot be submitted." : t.attr("required") ? i ? p.test(t.attr("type")) && (m.test(i) || (r = "Please enter a valid email address for: " + n)) : r = "Please fill out the required field: " + n : "g-recaptcha-response" !== n || i || (r = "Please confirm you’re not a robot.");
                    return r
                }(a, s, u, c)
            }), i
        }
